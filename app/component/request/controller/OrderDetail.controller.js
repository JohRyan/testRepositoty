sap.ui.define([
    ...
    return Controller.extend("project1.component.request.controller.OrderDetail",{
        ...
        onMyRoutePatternMatched: async function(){
            ...
            console.log("RequestModel.oData[0] : "+RequestModel.oData[0]);

            let visibleMode = new JSONModel({ footer: false, reject: false });
            console.log("visibleMode : "+visibleMode.footer+","+visibleMode.reject)
            console.log("RequestModel.oData[0].request_state : "+RequestModel.oData[0].request_state);
            if (RequestModel.oData[0].request_state == 'B') {
            visibleMode.oData.footer = true;
            console.log("B :  "+visibleMode.oData.reject_state);
            } else if (RequestModel.oData[0].request_state == 'C') {
            visibleMode.oData.reject = true;
            console.log("C :  "+visibleMode.oData.reject_state);
            }
